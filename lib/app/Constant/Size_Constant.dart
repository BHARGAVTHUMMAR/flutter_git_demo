...
class Spacing {
  ...
  static EdgeInsetsGeometry only(
    ...
    return EdgeInsets.only(
      left: AppSize.getWidth(left),
      right: AppSize.getWidth(right),
      top: AppSize.getHeight(top),
      bottom: AppSize.getHeight(bottom),
    );
  }
  ...
  static EdgeInsetsGeometry all(double spacing) {
    return Spacing.only(
        bottom: AppSize.getHeight(spacing),
        top: AppSize.getHeight(spacing),
        right: AppSize.getWidth(spacing),
        left: AppSize.getWidth(spacing));
  }
  ...
  static EdgeInsetsGeometry nTop(double spacing) {
    return Spacing.only(bottom: spacing, left: spacing, right: spacing);
  }
  ...
  static EdgeInsetsGeometry nBottom(double spacing) {
    return Spacing.only(left: spacing, right: spacing, top: spacing);
  }
  ...
  static EdgeInsetsGeometry vertical(double spacing) {
    return Spacing.only(
        top: AppSize.getHeight(spacing), bottom: AppSize.getHeight(spacing));
  }

  static EdgeInsetsGeometry symmetric(
      {double vertical = 0, double horizontal = 0}) {
    return Spacing.only(
        top: AppSize.getHeight(vertical),
        right: AppSize.getWidth(horizontal),
        left: AppSize.getWidth(horizontal),
        bottom: AppSize.getHeight(vertical));
  }
...
class Space {
  ...
  static Widget height(double space) {
    return SizedBox(
      height: AppSize.getHeight(space),
    );
  }

  static Widget width(double space) {
    return SizedBox(
      width: AppSize.getWidth(space),
    );
  }
}
...
class Shape {
  static dynamic circular(double radius,
    ...
    BorderRadius.all(Radius.circular(AppSize.getHeight(radius)));
  ...
  static dynamic circularTop(double radius,
    ...
    BorderRadius borderRadius = BorderRadius.only(
        topLeft: Radius.circular(AppSize.getHeight(radius)),
        topRight: Radius.circular(AppSize.getHeight(radius)));
    switch (shapeTypeFor) {
      case ShapeTypeFor.container:
        return borderRadius;
